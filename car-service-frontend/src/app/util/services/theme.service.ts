...
export class ThemeService {
  ...
  private overrideColors(themeMode: any) {
    switch (JSON.parse(themeMode)) {
      case 'light': {
        ...
        document.documentElement.style.setProperty('--router-text-color', '#111111');
      ...
      case 'dark': {
        ...
        document.documentElement.style.setProperty('--router-text-color', '#ffffff');
